    ...
    <div className='flex w-full h-full absolute left-0 top-[60px] mb-10 pt-10 lg:pt-20 bg-[#F8F8F8] justify-center'>
        <div className='bg-white rounded-lg xl:h-[80vh] flex gap-6 flex-wrap justify-between items-center p-14 pt-6 w-[60%]'>
            <div>
                ...
                <div className='border-dashed rounded-xl border-4 border-gray-200 flex flex-col justify-center items-center outline-none mt-10 w-[260px] h-[460px] p-10 cursor-pointer hover:boder-red hover:bg-gray-100'>
                    {isLoading ? (
                        <p>Uploading...</p>
                    ) : (
                        <div>
                    ...
                    {wrongFileType ? <p className='text-center text-xl text-red-400 font-semibold mt-4 w-[250px]'>Please select a video file</p> : null}
                </div>
            ...
            <div className='flex flex-col gap-3 pb-10'>
                    ...
                    <div className='flex gap-6 mt-10'>
                        <button onClick={clearFields} type='button' className='border-gray-300 border-2 text-md font-medium p-2 rounded w-28 lg:w-44 outline-none'>Discard</button>
